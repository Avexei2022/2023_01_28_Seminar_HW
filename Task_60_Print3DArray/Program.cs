...
void PrintTask() {
    Console.WriteLine("Задайте трехмерный массив размером X, Y, Z.\n"+ 
    "Программа заполнит массив случайными двузначными неповторяющимися числами\n"+
    "и построчно выведет массив с индексами каждого элемента.\n");
}
