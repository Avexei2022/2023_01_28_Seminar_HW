...
void PrintTask() {
    Console.WriteLine("Задайте двумерный массив размером n x n (в пределах от 3 до 9).\n"+ 
    "По условиям задачи массив должен быть 4 х 4.\n"+
    "Программа спирально заполнит массив\n"+
