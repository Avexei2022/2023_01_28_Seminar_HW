...
void PrintTask() {
    Console.WriteLine("Задайте прямоугольный двумерный массив размером m x n.\n"+ 
    "Программа заполнит массив случайными целыми числами,\n"+
    "сосчитает сумму элементов в каждой строке\n"+
    "выдаст номер строки с наименьшей суммой элементов.\n");
}
